...
//		const char arr[] = "Test";
//		cout << "测试 assign 函数" << endl;
//
//		// 测试 assign(const TStringAdv &ts2)
//		s1.assign(TStringAdv("ABC"));
//		cout << "s1应为ABC，实际输出：" << s1 << endl;
//
//		// 测试 assign(const char *s)
//		s1.assign(cstr);
//		cout << "s1应为Hello World，实际输出：" << s1 << endl;
//
//		// 测试 assign(const char *s)空字符串
//		s1.assign("");
//		cout << "s1应为<EMPTY>，实际输出：" << s1 << endl;
//
//		// 测试 assign(char数组)
//		s1.assign(arr);
//		cout << "s1应为Test，实际输出：" << s1 << endl;
//
//
//		// 连续调用检验稳定性
//		s1.assign("First").assign("Second");
//		cout << "s1应为Second，实际输出：" << s1 << endl;
//
//		wait_for_enter();
//	}
//
...
//		const char* cstr = "!";
//		const char arr[] = "123";
//		cout << "测试 append 函数" << endl;
//
//		// append(const TStringAdv &ts2)
//		s1.append(s2);
//		cout << "s1应为HelloWorld，实际输出：" << s1 << endl;
//
//		// append(const char *s)
//		s1.append(cstr);
//		cout << "s1应为HelloWorld!，实际输出：" << s1 << endl;
...
//		// append(char数组)
//		s1.append(arr);
//		cout << "s1应为HelloWorld!123，实际输出：" << s1 << endl;
//
//		// append空串
//		s1.append("");
//		cout << "s1应为HelloWorld!123，实际输出：" << s1 << endl;
...
//		// 连续append检验
//		s1 = "Hi";
//		s1.append(" ").append("There").append(" ").append("Friend");
//		cout << "s1应为Hi There Friend，实际输出：" << s1 << endl;
//
//		wait_for_enter();
//	}
//
...
//		s1.insert(s2, 3);
//		cout << "s1应为ABxyzCDEFG，实际输出：" << s1 << endl;
//
//		// insert(const char *s, int pos)
//		s1.insert(cstr, 1);
//		cout << "s1应为123ABxyzCDEFG，实际输出：" << s1 << endl;
//
//		// insert(字符数组,中间位置)
//		s1.insert(arr, 10);
//		cout << "s1应为123ABxyzC!DEFG，实际输出：" << s1 << endl;
//
//		// insert越界测试：pos超过长度不插入
//		s1.insert("OVER", 999);
//		cout << "s1应为123ABxyzC!DEFG，实际输出：" << s1 << endl;
//
//		// insert空串不改变
...
//
//		// insert尾0则截断
//		s1.insert('\0', s1.length() + 1);
//		cout << "s1应为123ABxyzC!DEFG，实际输出：" << s1 << endl;
//
//		// insert尾0则截断
//		s1.insert('\0', 6);
//		cout << "s1应为123AB，实际输出：" << s1 << endl;
//
//		// insert尾0则截断
//		s1.insert('\0', 1);
//		cout << "s1应为<EMPTY>，实际输出：" << s1 << endl;
...
//	// 测试 erase 函数
//	if (1) {
//		TStringAdv s1("HelloWorldHello"), s2("Hello");
//		const char* cstr = "World";
//		const char arr[] = "o W";
//
//		cout << "测试 erase 函数(删除匹配子串的首个出现)" << endl;
//
//		// erase(const TStringAdv &ts2)
//		s1.erase(s2);
//		cout << "s1应为 WorldHello，实际输出：" << s1 << endl;
//
//		// erase(const char *s)
//		s1.erase(cstr);
//		cout << "s1应为Hello，实际输出：" << s1 << endl;
//
//		// erase(字符数组)
//		s1.erase(arr);
//		cout << "s1应为Hello，实际输出：" << s1 << endl;
...
//		// 连续erase测试
//		s1 = "abcdefgabc";
//		s1.erase("abc").erase("abc");
//		cout << "s1应为defg，实际输出：" << s1 << endl;
//
//		wait_for_enter();
//	}
//
//	// 测试 substr 函数
//	if (1) {
//		TStringAdv s1("Hello World!");
//		cout << "测试 substr 函数" << endl;
//
//		// substr(pos, len)
//		TStringAdv sub = s1.substr(1, 5);
//		cout << "sub应为Hello，实际输出：" << sub << endl;
//
//		// 超出范围的len截断到字符串末尾
//		sub = s1.substr(7, 50);
//		cout << "sub应为World!，实际输出：" << sub << endl;
//
//		// 无len返回原串
//		sub = s1.substr(1);
//		cout << "sub应为Hello World!，实际输出：" << sub << endl;
//
//		// pos非法返回空串
//		sub = s1.substr(999, 3);
//		cout << "sub应为<EMPTY>，实际输出：" << sub << endl;
//
//		sub = s1.substr(-1, 3);
//		cout << "sub应为<EMPTY>，实际输出：" << sub << endl;
//
...
//	
//
//	// 测试 TStringLen 函数(返回长度)
//	if (1) {
//		TStringAdv s1;
//		cout << "测试 TStringLen 函数" << endl;
//
//		s1 = "Hello";
//		cout << "s1应为Hello，长度应为5，TStringLen输出：" << TStringAdvLen(s1) << endl;
//
//		s1 = "";
//		cout << "s1应为空串，长度应为0，TStringLen输出：" << TStringAdvLen(s1) << endl;
//
//		s1 = "123456789";
//		cout << "s1应为123456789，长度应为9，TStringLen输出：" << TStringAdvLen(s1) << endl;
//
//		wait_for_enter();
//	}
//
