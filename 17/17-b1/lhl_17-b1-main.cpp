...
//
//	if (1) {
//		TStringAdv s1, s2 = "", s3 = "hello";
//		char str[] = "world";
//		cout << "assign函数测试" << endl;
//		s1.assign("");
//		cout << "s1应为<EMPTY>，实际：" << s1 << endl;
//		s2.assign(s2);
//		cout << "s2应为<EMPTY>，实际：" << s1 << endl;
//		s2.assign(s3);
//		cout << "s2应为hello，实际：" << s2 << endl;
//		s3.assign(str);
//		cout << "s3应为world，实际：" << s3 << endl;
//		s3.assign("你好世界");
//		cout << "s3应为你好世界，实际：" << s3 << endl;
//		wait_for_enter();
//	}
//
//	if (1) {
//		TStringAdv s1, s2 = "", s3 = "tongji";
//		char str[] = " university", c = '!';
//		cout << "append函数测试" << endl;
//		s1.append(s2);
//		cout << "s1应为<EMPTY>，实际：" << s1 << endl;
//		s2.append(s3);
//		cout << "s2应为tongji，实际：" << s2 << endl;
//		s3.append(str);
//		cout << "s3应为tongji university，实际" << s3 << endl;
//		s3.append(c);
//		cout << "s3应为tongji university!，实际" << s3 << endl;
//		wait_for_enter();
//	}
...
//	{
//		TStringAdv s1, s2 = "", s3 = "tongji";
//		char str[] = " university", c1 = '!', c2 = 0;
//		cout << "insert函数测试" << endl;
//		s1.insert(s3, 1);
//		cout << "s1应为tongji，实际：" << s1 << endl;
//		s1.insert(str, 7);
//		cout << "s1应为tongji university，实际：" << s1 << endl;
//		s2.insert(s3, 2);
//		cout << "s2应为<EMPTY>，实际：" << s2 << endl;
//		s3.insert(str, 5);
//		cout << "s3应为tong universityji，实际：" << s3 << endl;
//		s3.insert(c1, 2);
//		cout << "s3应为t!ong universityji，实际：" << s3 << endl;
//		s3.insert(c2, 1);
//		cout << "s3应为<EMPTY>，实际：" << s3 << endl;
//		wait_for_enter();
//	}
//
//	if (1)
//	{
//		TStringAdv s1 = "tongji", s2 = "on";
//		char str[] = "gj", c = 'i';
//		cout<< "erase函数测试" << endl;
//		s1.erase(s2);
//		cout << "s1应为tgji，实际" << s1 << endl;
//		s1.erase(str);
//		cout << "s1应为ti，实际" << s1 << endl;
//		s1.erase(c);
//		cout << "s1应为t，实际" << s1 << endl;
//		wait_for_enter();
//	}
//
//	if (1)
//	{
//		TStringAdv s1 = "hello tongji";
//		cout << "substr函数测试" << endl;
//		cout << "子串应为<EMPTY>，实际：" << s1.substr(-1) << endl;
//		cout << "子串应为<EMPTY>，实际：" << s1.substr(1, -2) << endl;
//		cout << "子串应为hello tongji，实际：" << s1.substr(1) << endl;
//		cout << "子串应为llo tongji，实际：" << s1.substr(3, 100) << endl;
//		cout << "子串应为llo，实际：" << s1.substr(3, 3) << endl;
//		wait_for_enter();
//	}
//
//	if (1)
//	{
//		TStringAdv s1 = "abcdefghijklmnopqrstuvwxyz";
//		cout << "at函数测试" << endl;
//		cout << "字符应为b，实际" << s1.at(1) << endl;
//		s1.at(1) -= 32;
//		cout << "字符串应为aBcdefghijklmnopqrstuvwxyz，实际：" << s1 << endl;
//		wait_for_enter();
//	}
//
//	if (1)
//	{
//		TStringAdv s1 = "hello classmate", s2, s3 = "";
//		cout << "TStringAdvLen函数测试" << endl;
//		cout << "s1的长度应为15，实际：" << TStringAdvLen(s1) << endl;
//		cout << "s2的长度应为0，实际：" << TStringAdvLen(s2) << endl;
//		cout << "s3的长度应为0，实际：" << TStringAdvLen(s3) << endl;
//		wait_for_enter();
//	}
//
//#if !(defined(__linux) || defined(__linux__))
